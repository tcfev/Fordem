...
///   * [NotusAttribute.mentionPerson]
///   * [NotusAttribute.mentionPost]
///   * [NotusAttribute.mentionTopic]
...
class NotusAttribute<T> implements NotusAttributeBuilder<T> {
  static final Map<String, NotusAttributeBuilder> _registry = {
    ...
    NotusAttribute.mentionPerson.key: NotusAttribute.mentionPerson,
    NotusAttribute.mentionPost.key: NotusAttribute.mentionPost,
    NotusAttribute.mentionTopic.key: NotusAttribute.mentionTopic,
    NotusAttribute.direction.key: NotusAttribute.direction,
    NotusAttribute.alignment.key: NotusAttribute.alignment,
    NotusAttribute.date.key: NotusAttribute.date,
  };
  ...
  /// Date attribute
  static const date = DateAttributeBuilder._();

  /// Link style attribute.
  // ignore: const_eval_throws_exception
  static const link = LinkAttributeBuilder._();

  /// Mention person style attribute.
  static const mentionPerson = MentionPersonAttributeBuilder._();

  /// Mention post style attribute.
  static const mentionPost = MentionPostAttributeBuilder._();

  /// Mention topic style attribute.
  static const mentionTopic = MentionTopicAttributeBuilder._();
...
/// builder for mention person attribute values.
///
/// There is no need to use this class directly, consider using
/// [NotusAttribute.mentionPerson] instead.
class MentionPersonAttributeBuilder extends NotusAttributeBuilder<int> {
  static const _kMentionPerson = '@';

  const MentionPersonAttributeBuilder._()
      : super._(_kMentionPerson, NotusAttributeScope.inline);

  NotusAttribute<int> withId(int id) => NotusAttribute<int>._(key, scope, id);
}

/// builder for mentioning post attribute values.
///
/// There is no need to use this class directly, consider using
/// [NotusAttribute.mentionPost] instead.
class MentionPostAttributeBuilder extends NotusAttributeBuilder<int> {
  static const _kMentionPost = '&&';

  const MentionPostAttributeBuilder._()
      : super._(_kMentionPost, NotusAttributeScope.inline);

  NotusAttribute<int> withId(int id) => NotusAttribute<int>._(key, scope, id);
}

/// builder for mentioning topic attribute values.
///
/// There is no need to use this class directly, consider using
/// [NotusAttribute.mentionTopic] instead.
class MentionTopicAttributeBuilder extends NotusAttributeBuilder<int> {
  static const _kMentionTopic = '#';

  const MentionTopicAttributeBuilder._()
      : super._(_kMentionTopic, NotusAttributeScope.inline);
...
/// Builder for direction attribute styles.
///
/// There is no need to use this class directly, consider using
/// [NotusAttribute.direction] instead.
...
/// Builder for date attribute styles.
///
/// There is no need to use this class directly, consider using
/// [NotusAttribute.date] instead.
class DateAttributeBuilder extends NotusAttributeBuilder<Map<String, dynamic>> {
  const DateAttributeBuilder._()
      : super._(DateAttribute._kDate, NotusAttributeScope.inline);

  NotusAttribute<Map<String, dynamic>> gregorian(
          {String format, String date}) =>
      DateAttribute.gregorian(format: format, date: date);

  NotusAttribute<Map<String, dynamic>> solar({String format, String date}) =>
      DateAttribute.solar(format: format, date: date);

  NotusAttribute<Map<String, dynamic>> lunar({String format, String date}) =>
      DateAttribute.lunar(format: format, date: date);

  @override
  NotusAttribute<Map<String, dynamic>> get unset => DateAttribute._(null);

  @override
  NotusAttribute<Map<String, dynamic>> withValue(Map<String, dynamic> value) =>
      DateAttribute._(value);
}

/// Type of date content.
enum DateType { gregorian, solar, lunar }

class DateAttribute extends NotusAttribute<Map<String, dynamic>> {
  static const _kValueEquality = MapEquality<String, dynamic>();
  static const _kDate = 'date';
  static const _kGregorianDate = 'gregorian';
  static const _kSolarDate = 'solar';
  static const _kLunarDate = 'lunar';

  DateAttribute._(Map<String, dynamic> value)
      : super._(_kDate, NotusAttributeScope.inline, value);

  DateAttribute.gregorian({String format, String date})
      : this._(<String, dynamic>{
          'type': _kGregorianDate,
          'format': format,
          'date': date
        });

  DateAttribute.solar({String format, String date})
      : this._(<String, dynamic>{
          'type': _kSolarDate,
          'format': format,
          'date': date
  ...
  DateAttribute.lunar({String format, String date})
      : this._(<String, dynamic>{
          'type': _kLunarDate,
          'format': format,
          'date': date
  ...
  /// Type of date.
  DateType get type {
    if (value['type'] == _kGregorianDate) return DateType.gregorian;
    if (value['type'] == _kSolarDate) return DateType.solar;
    if (value['type'] == _kLunarDate) return DateType.lunar;
    assert(false, 'Unknown date attribute value $value.');
    return null;
  }
  ...
  bool operator ==(other) {
    if (identical(this, other)) return true;
    if (other is! DateAttribute) return false;
    DateAttribute typedOther = other;
    return key == typedOther.key &&
        scope == typedOther.scope &&
