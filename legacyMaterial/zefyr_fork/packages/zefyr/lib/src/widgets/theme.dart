...
class ZefyrThemeData {
  ...
  final CodeSnippetStyle codeSnippetStyle;

  /// Style theme for date.
  final TextBlockTheme date;
  ...
  factory ZefyrThemeData.fallback(BuildContext context) {
    ...
    return ZefyrThemeData(
      ...
      codeSnippetStyle: CodeSnippetStyle.github,
      date: TextBlockTheme(
        style: TextStyle(
          color: Colors.black,
          fontSize: 11
  ...
  ZefyrThemeData copyWith({
    ...
    TextBlockTheme code,
    CodeSnippetStyle codeEditorStyle,
    TextBlockTheme date,
  }) {
    return ZefyrThemeData(
      bold: bold ?? this.bold,
      ...
      code: code ?? this.code,
      codeSnippetStyle: codeEditorStyle ?? codeSnippetStyle,
      date: date ?? this.date,
    );
  }
  ...
  ZefyrThemeData merge(ZefyrThemeData other) {
    return copyWith(
      ...
      quote: other.quote,
      code: other.code,
      codeEditorStyle: other.codeSnippetStyle,
      date: other.date,
    );
  }
}
